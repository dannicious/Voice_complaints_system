    ...
    if ($username === '' || $password === '') {
        ...
        if (!$user) {
            ...
            if ($stored !== '' && password_verify($password, $stored)) {
                ...
                // Legacy plaintext password detected — accept it, then rehash for security
                $valid = true;
                try {
                    ...
                    // ignore update errors — login still proceeds
                }
            }
            ...
            if (!$valid) {
                ...
                login_user($user);
                header('Location: ../Ui-main/student/student_dashboard.php');
                exit;
            }
        }
    }
...
<head>
    ...
    <title>Student Login - VOICE</title>
...
<body>
    <div class="auth-card">
        ...
        <div class="auth-sub">Student Login:</div>
